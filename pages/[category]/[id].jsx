        ...
        <div className=" md:h-[385px] lg:h-[592px] grid gap-5 md:grid-cols-2">
          {product?.gallery.map((image, idx) => {
            return (
              <div
                key={idx}
                className="overflow-hidden rounded-lg md:last-of-type:row-start-1 md:last-of-type:col-start-2 md:last-of-type:row-span-2"
              >
                <img
                  src={image.mobile}
                  alt=""
        ...
        <div className="space-y-10">
          ...
          <div className="grid gap-10 md:gap-5 md:grid-cols-3">
            {product?.others.map((prod, idx) => {
              return (
                <div key={idx} className="space-y-5 overflow-hidden rounded-lg">
                  <>
                    <img
